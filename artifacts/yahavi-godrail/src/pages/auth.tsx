      ...
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary/10 mb-2">
            <span className="text-2xl font-extrabold text-primary">YG</span>
          </div>
          <h1 className="text-3xl font-bold tracking-tight">Yahavi Godrail</h1>
          <p className="text-muted-foreground text-sm">Professional social media management platform</p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <Input id="reg-name" placeholder="Jane Smith" value={registerForm.name}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input id="reg-password" type="password" placeholder="Min. 8 characters" value={registerForm.password}
                      onChange={(e) => setRegisterForm((p) => ({ ...p, password: e.target.value }))} required minLength={8} />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="reg-confirm">Confirm Password</Label>
                    <Input id="reg-confirm" type="password" placeholder="Repeat password" value={registerForm.confirm}
                      onChange={(e) => setRegisterForm((p) => ({ ...p, confirm: e.target.value }))} required />
                  </div>
                  <Button type="submit" className="w-full" disabled={loading}>
                    {loading ? <Loader2 className="h-4 w-4 animate-spin mr-2" /> : null}
                    Create Account
